  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Construction Tool Rental - Your one-stop solution for easy and convenient rental of construction tools from a trusted supplier with multiple outlets."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Construction Tool Rental - Your one-stop solution for easy and convenient rental of construction tools from a trusted supplier with multiple outlets.`}
            </Text>
            <Box
