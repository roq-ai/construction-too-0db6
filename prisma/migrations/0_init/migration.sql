...
-- AddForeignKey
ALTER TABLE "rental_request" ADD CONSTRAINT "rental_request_inventory_id_fkey" FOREIGN KEY ("inventory_id") REFERENCES "inventory"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
